			 ...
			 enum pm_qos_req_action action, int value)
{
	...
	if (c->notifiers)
		srcu_notifier_call_chain(c->notifiers, curr_value, NULL);
...
{
	return srcu_notifier_chain_register(cpu_dma_constraints.notifiers,
						notifier);
}
...
{
	return srcu_notifier_chain_unregister(cpu_dma_constraints.notifiers,
						  notifier);
}
